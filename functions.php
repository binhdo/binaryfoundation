...
function binaryfoundation_setup() {
	...
	register_nav_menu( 'primary', __( 'Navigation Menu', 'binaryfoundation' ) );
...
function binaryfoundation_scripts_styles() {
	...
	wp_enqueue_script( 'binaryfoundation-script', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '20130625a', true );

	// Loads our main stylesheet.
	wp_enqueue_style( 'binaryfoundation-style', get_stylesheet_uri() );

	// Loads the Internet Explorer specific stylesheet.
	wp_enqueue_style( 'binaryfoundation-ie', get_template_directory_uri() . '/css/ie.css', array( 'binaryfoundation-style' ), '20130213' );
	$wp_styles->add_data( 'binaryfoundation-ie', 'conditional', 'lt IE 9' );
}
